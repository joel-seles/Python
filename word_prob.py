#Word Problems , word_prob.py
# Demonstrating numbers and math
# jseles, 10 July 2014
...
print("your friends split it evenly four ways, how much do you each throw in?")
input("Press the enter key to find out.")
print("19 / 4 =", 19 / 4)
...
print("\nIf that same group of pirates evenly divides the chest full of gold coins, how many coins are left over?")
input("Press the enter key to find out.")
print("107 % 4 =", 107 % 4)
